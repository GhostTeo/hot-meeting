...
export function holidayException(holiday) {
  return {
    from: holiday.from,
    to: holiday.to,
    closed: true,
...
export function openingException(opening) {
  return {
    date: opening.date,
    closed: false,
...
export function addHoliday(calendar, holiday) {
  return { ...calendar, exceptions: [...(calendar.exceptions || []), holidayException(holiday)] };
}

export function addExceptionalOpening(calendar, opening) {
  return { ...calendar, exceptions: [...(calendar.exceptions || []), openingException(opening)] };
}
